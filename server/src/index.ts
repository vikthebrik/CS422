...
app.get('/events', async (req, res) => {
    try {
        // Fetch events with joined Club, Type, and Collaborations
        ...
        // Transform data to a cleaner format for frontend if needed, 
        // or just return as is. The frontend needs to handle the nested structure.
        // Let's return as is to keep backend simple, but maybe flatten type name.
